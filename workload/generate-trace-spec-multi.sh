...
cd ${GEM5_PATH}
${GEM5_PATH}/build/ARM/gem5.opt -d ${OUTDIR} --debug-flags=TimeNoti \\
    ...
    --mem-size=4GB --mem-type=SimpleMemory --mem-latency='5ns' \\
    ...
    --script="${GEM5_PATH}/script/multi/${1}.sh" -I 5000000000 --time-noti-interval=10000000000
EOF
}
