...
rm /home/hjchoi/jobs/spec/replay/single/*

function generate_job() {
cat > "/home/hjchoi/jobs/spec/replay/single/qsub_replay_${1}_${2}_${3}_${4}.sh" << EOF
#!/bin/bash
#$ -N r${1}_${2}_${3}_${4}
#$ -S /bin/bash
#$ -j y
...
/home/hjchoi/git/cxl-sim/build/ARM/gem5.opt \\
    ...
    --data-trace-files=${TRACEDIR}/system.switch_cpus.traceListener.deptrace.proto.gz \\
    --inst-trace-files=${TRACEDIR}/system.switch_cpus.traceListener.fetchtrace.proto.gz \\
...
chmod 755 /home/hjchoi/jobs/spec/replay/single/*
